    ...
    <PageLayout className="px-3 sm:px-4 md:px-6 lg:px-12 pt-24 pb-16 sm:pb-20 md:pb-24 lg:pt-12 lg:pb-12 overflow-x-hidden">
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10 md:space-y-12 case-study-section">
        ...
        <div className="reveal-on-scroll">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Otagon AI Gaming Companion</h1>
          <a 
            href="https://otagon.app" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 bg-accent-primary text-white rounded-lg hover:bg-accent-hover transition-colors text-sm font-medium mb-4"
          >

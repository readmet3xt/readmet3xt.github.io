      ...
      <div className="max-w-4xl mx-auto space-y-12 case-study-section">
        ...
        <div className="reveal-on-scroll">
          ...
          <p className="text-lg leading-relaxed">
            What if women's invisible labor at home could be economically valued and compensated? As project lead at the Royal College of Art, I designed a Core77-award-winning speculative service that reimagines women's work-life balance by 2040. Through research with 79 working women and co-creation workshops with BCG, I developed the Invisible Value Income (I.V.I.) Program—a future-facing system that makes unpaid domestic work visible, measurable, and compensated, creating pathways to healthier, more equitable workplaces.
          </p>
        </div>
        ...
        <ProjectOverviewCard
          ...
          recognition="Core77 Design Awards 2021 - Notable Honor in Speculative Design category"
          tools={[
            "Speculative Design",
            "Service Design",
            "Systems Thinking",
        ...
        <section className="reveal-on-scroll">
          ...
          <p>The modern working woman navigates a punishing intersection: professional ambitions clash with societal expectations, personal wellbeing competes with invisible domestic labor. As project lead for "A Soul at Work" at the Royal College of Art, I guided our team through an ambitious speculative design challenge: <em>How might we fundamentally reimagine our relationship with work for women by 2040?</em></p>

          <p className="mt-4">I led end-to-end research strategy, interviewing 79 working women across diverse sectors and countries to map systemic pressures. Through intensive co-creation workshops with BCG stakeholders and synthesis with wellbeing specialists, I developed the Invisible Value Income (I.V.I.) Program—a speculative government service that makes women's unpaid domestic contributions economically visible and compensated. The work earned a Core77 Design Awards Notable Honor (2021) and directly influenced BCG's internal equity research framework.</p>
        </section>
        ...
        <section className="reveal-on-scroll">
          ...
          <div className="mt-8">
            <ImagePlaceholder
              label="Unpaid Work Statistics Visualization"
              aspectRatio="4/3"
              dimensions="1000x750"
              className="case-study-image"
            />
        ...
        <section className="reveal-on-scroll">
          ...
          <div className="my-6">
            <ImagePlaceholder
              label="Sensei Platform Interface"
              aspectRatio="16/9"
              dimensions="1200x675"
            />
          </div>

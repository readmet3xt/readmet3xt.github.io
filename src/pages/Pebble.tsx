      ...
      <div className="max-w-4xl mx-auto space-y-12 case-study-section">
        ...
        <div className="reveal-on-scroll">
          ...
          <p className="text-lg leading-relaxed">
            What if workplace happiness wasn't a perk, but a designed system? As project lead at the Royal College of Art, I created Pebble—a VISA-backed virtual wellbeing companion that transforms how remote teams combat isolation. Through research with 1,200+ workers and 24 co-creation workshops, I designed personalized happiness interventions and the "Virtual Café" feature that VISA adopted for their internal collaboration roadmap, proving that proactive wellbeing design drives measurable productivity gains.
          </p>
        </div>

        <ProjectOverviewCard
          role={[
            "Project Lead, Designer & UX Researcher",
            "Designed and facilitated 24 workshops (public + VISA Innovation Centre)",
            "Led user research synthesis (1200+ survey responses)",
            "Designed UI/UX for Pebble companion and Virtual Café feature"
          ]}
          team="Collaborated with Jing Qian and Zhiyuan Zheng (RCA), VISA Innovation Centre stakeholders"
          timeline="Royal College of Art + VISA Innovation Centre collaboration - 3 months"
          recognition="Received exceptional feedback from senior designers; Virtual Café concept influenced VISA's team chat feature development"
          tools={[
            "Service Design",
        ...
        <section className="reveal-on-scroll">
          <ImagePlaceholder
            label="Pebble Virtual Companion"
            aspectRatio="16/9"
            dimensions="1200x675"
        ...
        <section className="reveal-on-scroll">
          ...
          <p>Remote work promised freedom. It delivered isolation. While flexible work models unlocked unprecedented productivity gains, they simultaneously revealed a workforce drowning in stress, loneliness, and the collapse of work-life boundaries. As project lead for a Royal College of Art × VISA collaboration, I saw an urgent opportunity: <em>How might we proactively design for workplace happiness rather than reactively treating burnout?</em></p>
          
          <p className="mt-4">This case study chronicles Pebble—a virtual wellbeing companion born from 1,200+ worker interviews and 24 co-creation workshops. Through human-centered design, we created a service that doesn't just track employee sentiment but actively cultivates connection, focus, and sustainable happiness. Our mission: prove that wellbeing isn't an HR checklist—it's a competitive advantage when designed systemically into remote work culture.</p>
        </section>
        ...
        <section className="reveal-on-scroll">
          ...
          <div className="case-study-grid-image my-8">
            <ImagePlaceholder
              label="Onboarding Quiz Interface"
              aspectRatio="9/16"
              dimensions="400x711"
            />
            <ImagePlaceholder
